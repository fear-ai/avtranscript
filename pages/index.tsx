      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Whether you're just starting out or running a business, we have solutions for you</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            <Link href="#search" className="group">
              <div className="p-6 rounded-lg bg-blue-50 hover:shadow-xl transition-all duration-200 hover:-translate-y-1 cursor-pointer">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">Amateur</h3>
                <div className="text-2xl font-bold text-blue-600 mb-3">Free</div>
                <p className="text-gray-600 mb-4 text-sm">Perfect for beginners and content creators. Start transcribing your audio and video content with our free tier.</p>
            ...
            <Link href="#search" className="group">
              <div className="p-6 rounded-lg bg-purple-50 hover:shadow-xl transition-all duration-200 hover:-translate-y-1 cursor-pointer">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-purple-600 transition-colors">Agency</h3>
                <div className="text-2xl font-bold text-purple-600 mb-3">Enterprise</div>
                <p className="text-gray-600 mb-4 text-sm">Enterprise-grade solutions for agencies and large organizations. Advanced features, team management, and priority support.</p>
                <ul className="text-left text-gray-600 mb-4 space-y-1 text-sm">
                  <li className="flex items-center">
                    <svg className="w-4 h-4 text-purple-500 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"></path>
                    </svg>
                    More expensive Enterprise Tier
                  </li>
                  <li className="flex items-center">
                    <svg className="w-4 h-4 text-purple-500 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"></path>
